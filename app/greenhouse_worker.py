...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run enabled Greenhouse company "
            "boards using dashboard rules."
        )
    )
    ...
    parser.add_argument(
        ...
        action="store_true",
        help=(
            "Run immediately while still "
            "requiring Greenhouse to be enabled."
        ),
    )
