...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Run enabled Ashby boards using "
            "dashboard targeting rules."
        )
    )
...
def main() -> None:
    ...
    output = {
        ...
        "secondary_location_matches": (
            filtered.get("secondary_location_matches", 0)
        ),
